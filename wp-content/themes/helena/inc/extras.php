...
if ( ! function_exists( 'helena_continue_reading' ) && ! is_admin() ) :
/**
 ...
 */
function helena_continue_reading( $the_excerpt ) {
...
add_filter( 'the_excerpt', 'helena_continue_reading', 9 );
endif;
...
add_filter( 'excerpt_length', 'helena_excerpt_length', 999 );

if ( ! function_exists( 'helena_excerpt_more' ) && ! is_admin() ) :
/**
 * Replaces "[...]" (appended to automatically generated excerpts) with a blank space.
 *
 */
function helena_excerpt_more( $more ) {
	return '';
}
add_filter( 'excerpt_more', 'helena_excerpt_more' );
endif;
